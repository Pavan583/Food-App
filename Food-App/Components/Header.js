import TasteTrek from '../Images/bgrTasteTrek.png'
...
const Title = () => (
  <Link to="/">
    <img className="logo" src={TasteTrek} alt="Food Fire" title="Food Fire" />
  </Link>
)
    ...
    <div className="header">
      ...
      {isLoggedin && (
        <div className="user-name">
          Hi {getLocalStorage?.userName}! Welcome to TasteTrek😊
        </div>
      )}
